<x-app-layout>
    ...
    <x-slot name="title">batch.edit || Master Genesis Prototype v1</x-slot>
    <x-slot name="heading">batch.edit</x-slot>
    ...
    <form 
        ...
        method="POST"
    >
        <h5 class="text-xl font-medium text-gray-900 dark:text-white text-center">Batch Edit</h5>
        @csrf
        @method('PUT')
